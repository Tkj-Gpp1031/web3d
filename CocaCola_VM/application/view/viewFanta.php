                ...
                <div class="col-sm-3">
                  <div class="card text-left">
                      ...
                      <div class="card-body" id="texture-card" style="display:none">
                        ...
                        <a class="btn btn-success btn-responsive" onclick="o=orange();">Orange</a>
                        <a class="btn btn-primary btn-responsive" onclick="apple();">Apple</a>
                        <a class="btn btn-secondary btn-responsive" onclick="grapes();">Grapes</a>
                        <div class="card-text x3dCameraDescription drinksText">
                          <p>These buttons select a limited range of X3D model viewpoints, use the dropdown menu for more camera views</p>
                        </div>
                      </div>
