...
<html lang="en">
  ...
  <body>
    ...
    <div class ="title1">
      <img src="../application/assets/images/fanta-organe-600x400-11.png" class="p2">
    </div>
          ...
          <div class="row">
              ...
              <div class="col-sm-8">
                  <div class="card text-left">
                      ...
                      <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                          <a id="navSprite" class="nav-link" href="ColaCan">Cola</a>
                          </li>
                          <li class="nav-item">
                          <a id="navSprite" class="nav-link" href="Sprite">Sprite</a>
                          </li>
                          <li class="nav-item">
                          <a id="navPepper" class="nav-link active" href="Fanta">Fanta</a>
                          </li>
                      </ul>
                      </div>
              ...
              <div class="col-sm-4">
                  <div class="card text-left">
                      ...
                      <div class="card-body">
                      <a href="../application/assets/images/renderImages/fanta.png" data-fancybox="" data-caption="My 3D Coke Can Render">
                            <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/images/dr_pepper.png" alt="Coca Cola">
                          </a>
