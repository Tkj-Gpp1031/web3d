        ...
        <div class="logo">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto"> <!-- Use mx-auto to align centre, default to left or use mr-auto -->
              ...
              <li class="nav-item">
                <a class="nav-link active" href="index_c.html">Home</a>
              </li>
                  ...
                  <div class="card text-left">
                      ...
                      <ul class="nav nav-tabs card-header-tabs">
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a id="navCoke" class="nav-link active" href="coke.html">Coke_Can</a>
                              <a id="navCoke" class="nav-link active" href="coke_b.html">Coke_Bottle</a>
                            </div>
                          </li>
                          <li class="nav-item">
                          <a id="navSprite" class="nav-link" href="sprite.html">Sprite</a>
                          </li>
                          <li class="nav-item">
                          <a id="navPepper" class="nav-link" href="fanta.html">Fanta</a>
                          </li>
                      </ul>
                      </div>
