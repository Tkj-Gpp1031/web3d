...
<html lang="en">
  ...
  <body>
        ...
        <div class="logo">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto"> <!-- Use mx-auto to align centre, default to left or use mr-auto -->
              ...
              <li class="nav-item">
                <a id="navModels" class="nav-link"  href="about" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="X3D Models" data-content="There are three X3D models: Coke, Sprite and Pepper">Models</a>
              </li>
              <li class="nav-item">
    ...
    <div class ="title1">
      <img src="../application/assets/images/coca-cola-OT-hug-11.png" class="p2">
    </div>
                  ...
                  <div class="card text-left">
                      ...
                      <ul class="nav nav-tabs card-header-tabs">
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <a id="navCoke" class="nav-link active" href="ColaCan">Coke_Can</a>
